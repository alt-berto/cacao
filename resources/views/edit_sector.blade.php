    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ URL::to('/sectores/'.$sector->id ) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('size') is-invalid @enderror" value="{{ $sector->size }}" type="number" name="size" id="size" autocomplete="size" autofocus>                    
                    @error('size')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('lat') is-invalid @enderror" value="{{ $sector->lat }}" type="text" name="lat" id="lat" autocomplete="lat" autofocus>                    
                    @error('lat')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('long') is-invalid @enderror" value="{{ $sector->long }}" type="text" name="long" id="long" autocomplete="long" autofocus>                    
                    @error('long')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('note') is-invalid @enderror" value="{{ $sector->note }}" type="text" name="note" id="note" autocomplete="note" autofocus>                    
                    @error('note')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
